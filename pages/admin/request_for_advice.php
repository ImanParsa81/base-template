<?php
global $wpdb;
$tbl = $wpdb->prefix . 'nirweb_need_advice';
...
<div class=" nirweb_admin_show_data ">
    ...
    <div class=" nirweb_admin_show_data_container ">
        ...
        <p class="nirweb_title_List_price_inquiry_records">لیست درخواست مشاوره</p>
                        ...
                        foreach ($list as $k => $item) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($item->status == NULL || $item->status == 0) {
                                        ?>
                                        <button class="need_advice_nirweb_menu_change_active"
                                                data="<?= $item->id ?>"> تغییر وضعیت
                                        </button>
                                        <?php
                                    }
                                    ?>
                                ...
                                <td>
                                    <button id_row_delete="<?= $item->id ?>"
                                            class="need_advice_nirweb_menu_change_active_delete" type="button"> حذف
                                        کردن.
                                    </button>
                                </td>
...
<style>
    ...
    .need_advice_nirweb_menu_change_active {
        padding: 5px 10px;
    ...
    .need_advice_nirweb_menu_change_active:hover {
        cursor: pointer;
    }

    .need_advice_nirweb_menu_change_active_delete {
        padding: 5px 10px;
    ...
    .need_advice_nirweb_menu_change_active_delete:hover {
        cursor: pointer;
    }
